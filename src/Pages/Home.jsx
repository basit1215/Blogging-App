              ...
              <article key={blog.documentId}
                ...
                <div className="w-1/2 pl-4">
                  ...
                  <Link
                    ...
                    className="btn btn-outline-info bg-blue-500 text-white font-semibold py-4 px-4 rounded-md hover:bg-blue-600 transition duration-300 mt-2 block text-center" >
